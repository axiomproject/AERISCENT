        ...
        <div className="preorder-grid">
          <div className="preorder-item">
            <div className="item-content">
              ...
              <div className="item-details">
                <p className="release-date">Launching December 15, 2025</p>
          ...
          <div className="preorder-item">
            <div className="item-content">
              ...
              <div className="item-details">
                <p className="release-date">Pre-order until December 24, 2025</p>
          ...
          <div className="preorder-item">
            <div className="item-content">
              ...
              <div className="item-details">
                <p className="release-date">Coming January 2026</p>
